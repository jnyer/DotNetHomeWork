...
namespace OrderForm {
  public partial class FormMain : Form {
    ...
    public FormMain() {
      ...
      Order order = new Order(1, new Customer("1", "a"), new List<OrderDetail>());
      order.AddItem(new OrderDetail(1, new Goods("1", "apple", 20.0), 10));
      order.AddItem(new OrderDetail(2, new Goods("2", "egg", 30.0), 20));
      orderService.AddOrder(order);
      Order order2 = new Order(2, new Customer("2", "aa"), new List<OrderDetail>());
      order2.AddItem(new OrderDetail(1, new Goods("2", "egg", 40.0), 10));
